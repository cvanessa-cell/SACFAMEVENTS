...
function parseCandidateIds(formData: FormData): string[] {
...
export async function bulkApproveSourceCandidatesAction(formData: FormData): Promise<void> {

  const candidateIds = parseCandidateIds(formData);
...
export async function bulkRejectSourceCandidatesAction(formData: FormData): Promise<void> {
...
export async function bulkApproveEventCandidatesAction(formData: FormData): Promise<void> {
...
export async function bulkRejectEventCandidatesAction(formData: FormData): Promise<void> {
